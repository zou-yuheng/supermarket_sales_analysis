...
> The dataset (\`supermarket*sales.csv*\`) is a classic public dataset widely used for business analysis learning. It contains no real-world personal privacy or commercial secrets.
...
1. Ensure \`supermarket*sales.csv*\` is placed in the root directory.
2. Install dependencies: \`pip install pandas matplotlib seaborn statsmodels\`
3. Run the analysis script: \`python main.py\`

## Project Documentation

- \`Supermarket*Sales*Report.docx\`: Detailed business analysis report (in Chinese).
